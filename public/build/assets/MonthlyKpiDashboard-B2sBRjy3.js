import{bo as $e,g as et,o as d,w as tt,e,a as r,s as Ue,t as s,n as Xe,F as u,i as h,v as Ve,ac as st,h as f,f as it,r as qe,a1 as at,c as Ze,A as ot,W as lt}from"./app-B6yE8LOk.js";import{_ as dt}from"./AdminLayout.vue_vue_type_script_setup_true_lang-Dla4wK9w.js";import{_ as rt}from"./_plugin-vue_export-helper-DSV2G5wh.js";import"./AppLayout.vue_vue_type_script_setup_true_lang-fW9bHL08.js";import"./Button.vue_vue_type_script_setup_true_lang-BCmbLoyf.js";import"./index-ByyNcVWT.js";import"./index-Cm0BeycD.js";import"./AppLogoIcon.vue_vue_type_script_setup_true_lang-ypd93s_P.js";import"./clock-TaqH5Jq1.js";const nt={name:"MonthlyKpiDashboard",components:{AdminLayout:dt},props:{kpiData:{type:Object,required:!0},filterData:{type:Object,required:!0},currentFilters:{type:Object,required:!0},lastUpdated:{type:String,required:!0}},setup(o){const t=qe(!1),i=qe(!1),l=qe(!1),_=at({month:o.currentFilters.month,year:o.currentFilters.year,department_id:o.currentFilters.department_id||"",course_id:o.currentFilters.course_id||""}),Be=Ze(()=>[{label:"Dashboard",href:route("dashboard")},{label:"Reports",href:route("admin.reports.index")},{label:"Monthly KPI Dashboard",href:null}]),Ie=async()=>{try{l.value=!0;const n=Ne(),c=window.open("","screenshot","width=1200,height=800");if(!c)throw new Error("Popup blocked. Please allow popups for this site.");c.document.write(n),c.document.close(),await new Promise(b=>setTimeout(b,1e3));const g=c.document.createElement("script");g.src="https://html2canvas.hertzen.com/dist/html2canvas.min.js",c.document.head.appendChild(g),await new Promise(b=>{g.onload=b}),await new Promise(b=>setTimeout(b,500));const v=await c.html2canvas(c.document.body,{backgroundColor:"#ffffff",scale:1.5,useCORS:!0,allowTaint:!0,width:c.document.body.scrollWidth,height:c.document.body.scrollHeight}),m=document.createElement("a");m.download=`KPI_Report_${_.month}_${_.year}_${new Date().toISOString().split("T")[0]}.png`,m.href=v.toDataURL("image/png",.9),document.body.appendChild(m),m.click(),document.body.removeChild(m),c.close(),console.log("✅ Screenshot generated successfully!"),alert("📸 Screenshot downloaded successfully!")}catch(n){console.error("❌ Screenshot failed:",n),alert(`Screenshot failed: ${n.message}

Please try using your browser's built-in screenshot feature.`)}finally{l.value=!1}},Ne=()=>{var n,c,g,v,m,b,y,w,D,C,P,S,T,A,z,R,N,E,F,O,L,M,j,U,I,V,q,B,K,W,Q,H,G,Y,J,X,Z,$,ee,te,se,ie,ae,oe,le,de,re,ne,ce,pe,ve,ge,me,be,xe,ue,he,_e,fe,ke,ye,we,De,Ce,Pe,Se,Te,Ae,ze,Re;return`
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="kpi-section">
        ...
        <div class="kpi-cards-grid" style="grid-template-columns: repeat(5, 1fr);">
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-value">${((z=(A=o.kpiData.online_course_analytics)==null?void 0:A.delivery)==null?void 0:z.active_online_learners)||0}</div>
            </div>
        </div>
    </div>
    ...
    <div class="kpi-section">
        ...
        <div class="kpi-cards-grid">
            ...
            <div class="kpi-card green">
                ...
                <div class="kpi-value">${((j=(M=o.kpiData.online_course_analytics)==null?void 0:M.video_engagement)==null?void 0:j.avg_video_completion)||0}%</div>
            </div>
            <div class="kpi-card purple">
                <div class="kpi-icon">⏱️</div>
            ...
            <div class="kpi-card orange">
                ...
                <div class="kpi-value">${((q=(V=o.kpiData.online_course_analytics)==null?void 0:V.video_engagement)==null?void 0:q.video_replay_count)||0}</div>
            </div>
        </div>
    </div>
    ...
    <div class="kpi-section">
        ...
        <div class="outcomes-grid">
            <div class="outcome-card success">
                ...
                <div class="outcome-value">${((B=o.kpiData.learning_outcomes)==null?void 0:B.quiz_pass_rate)||0}%</div>
            </div>
    ...
    <div class="kpi-section">
        ...
        <div class="kpi-cards-grid">
            <div class="kpi-card blue">
                ...
                <div class="kpi-value">${((G=(H=o.kpiData.online_course_analytics)==null?void 0:H.module_progress)==null?void 0:G.total_modules)||0}</div>
            </div>
            <div class="kpi-card green">
                <div class="kpi-icon">✅</div>
                <div class="kpi-label">Completed</div>
                <div class="kpi-value">${((J=(Y=o.kpiData.online_course_analytics)==null?void 0:Y.module_progress)==null?void 0:J.completed_modules)||0}</div>
            </div>
            <div class="kpi-card purple">
                <div class="kpi-icon">👤</div>
                ...
                <div class="simple-table">
                    ...
                    ${(((ye=(ke=o.kpiData.online_course_analytics)==null?void 0:ke.top_performers)==null?void 0:ye.top_online_courses)||[]).slice(0,5).map((p,x)=>`
                        <div class="table-row">
                            <div class="table-cell">${x+1}. ${p.name}</div>
                            <div class="table-cell">${p.completion_rate}%</div>
                            <div class="table-cell">${p.enrolled}</div>
                        </div>
                    `).join("")||'<div class="table-row"><div class="table-cell">No data available</div><div class="table-cell">-</div><div class="table-cell">-</div></div>'}
                </div>
            </div>
    ...
    <div class="kpi-section">
        ...
        <div class="trend-container">
            ...
            <div class="trend-card">
                ...
                <div class="trend-value">${((Ae=o.kpiData.engagement_trends)==null?void 0:Ae.previous_month_engagement)||0}%</div>
                <div class="trend-period">${((ze=o.kpiData.engagement_trends)==null?void 0:ze.trend_percentage)||0}% change</div>
            </div>
        </div>
    </div>
    ...
    <div class="report-footer">
        <div class="footer-content">
            <div class="footer-line"><strong>Report Period:</strong> ${((Re=o.kpiData.period)==null?void 0:Re.period_name)||"Current Period"}</div>
