import{bo as Ke,g as Be,o as r,w as Qe,e,a as n,s as te,t as a,n as qe,F as u,i as x,v as ae,ac as We,h as ie,f as $e,r as oe,a1 as He,c as Ge,A as Ye,W as Je}from"./app-Ds55_Mt0.js";import{_ as Xe}from"./AdminLayout.vue_vue_type_script_setup_true_lang-Bs1PH5XX.js";import{_ as Ze}from"./_plugin-vue_export-helper-BEHZCvKj.js";import"./AppLayout.vue_vue_type_script_setup_true_lang-CDrYFnlV.js";import"./Button.vue_vue_type_script_setup_true_lang-BTIuuHNy.js";import"./index-BPPjE_g4.js";import"./index-PuOJu81a.js";import"./AppLogoIcon.vue_vue_type_script_setup_true_lang-CjYfGJot.js";import"./clock-BnLTg5C6.js";const et={name:"MonthlyKpiDashboard",components:{AdminLayout:Xe},props:{kpiData:{type:Object,required:!0},filterData:{type:Object,required:!0},currentFilters:{type:Object,required:!0},lastUpdated:{type:String,required:!0}},setup(i){const t=oe(!1),o=oe(!1),d=oe(!1),h=He({month:i.currentFilters.month,year:i.currentFilters.year,department_id:i.currentFilters.department_id||"",course_id:i.currentFilters.course_id||""}),de=async()=>{try{d.value=!0;const l=se(),c=window.open("","screenshot","width=1200,height=800");if(!c)throw new Error("Popup blocked. Please allow popups for this site.");c.document.write(l),c.document.close(),await new Promise(b=>setTimeout(b,1e3));const g=c.document.createElement("script");g.src="https://html2canvas.hertzen.com/dist/html2canvas.min.js",c.document.head.appendChild(g),await new Promise(b=>{g.onload=b}),await new Promise(b=>setTimeout(b,500));const p=await c.html2canvas(c.document.body,{backgroundColor:"#ffffff",scale:1.5,useCORS:!0,allowTaint:!0,width:c.document.body.scrollWidth,height:c.document.body.scrollHeight}),m=document.createElement("a");m.download=`KPI_Report_${h.month}_${h.year}_${new Date().toISOString().split("T")[0]}.png`,m.href=p.toDataURL("image/png",.9),document.body.appendChild(m),m.click(),document.body.removeChild(m),c.close(),console.log("✅ Screenshot generated successfully!"),alert("📸 Screenshot downloaded successfully!")}catch(l){console.error("❌ Screenshot failed:",l),alert(`Screenshot failed: ${l.message}
