import{bo as re,g as ne,o as d,w as de,e,a as l,s as X,t as a,n as oe,F as x,i as f,v as ee,ac as le,h as Z,f as ce,r as te,a1 as ge,c as me,A as pe,W as ve}from"./app-B5QCrb6m.js";import{_ as be}from"./AdminLayout.vue_vue_type_script_setup_true_lang-q1ez3TJ_.js";import{_ as xe}from"./_plugin-vue_export-helper-De2CCZJH.js";import"./AppLayout.vue_vue_type_script_setup_true_lang-DJEC7YWG.js";import"./Button.vue_vue_type_script_setup_true_lang-HglPE9Uv.js";import"./index-Wv3lFKee.js";import"./index-DwxW3oru.js";import"./AppLogoIcon.vue_vue_type_script_setup_true_lang-BsvRm7AT.js";import"./clock-Bxh51ez1.js";const fe={name:"MonthlyKpiDashboard",components:{AdminLayout:be},props:{kpiData:{type:Object,required:!0},filterData:{type:Object,required:!0},currentFilters:{type:Object,required:!0},lastUpdated:{type:String,required:!0}},setup(r){const t=te(!1),i=te(!1),o=te(!1),u=ge({month:r.currentFilters.month,year:r.currentFilters.year,department_id:r.currentFilters.department_id||"",course_id:r.currentFilters.course_id||""}),se=async()=>{try{o.value=!0;const n=$(),c=window.open("","screenshot","width=1200,height=800");if(!c)throw new Error("Popup blocked. Please allow popups for this site.");c.document.write(n),c.document.close(),await new Promise(v=>setTimeout(v,1e3));const m=c.document.createElement("script");m.src="https://html2canvas.hertzen.com/dist/html2canvas.min.js",c.document.head.appendChild(m),await new Promise(v=>{m.onload=v}),await new Promise(v=>setTimeout(v,500));const g=await c.html2canvas(c.document.body,{backgroundColor:"#ffffff",scale:1.5,useCORS:!0,allowTaint:!0,width:c.document.body.scrollWidth,height:c.document.body.scrollHeight}),p=document.createElement("a");p.download=`KPI_Report_${u.month}_${u.year}_${new Date().toISOString().split("T")[0]}.png`,p.href=g.toDataURL("image/png",.9),document.body.appendChild(p),p.click(),document.body.removeChild(p),c.close(),console.log("✅ Screenshot generated successfully!"),alert("📸 Screenshot downloaded successfully!")}catch(n){console.error("❌ Screenshot failed:",n),alert(`Screenshot failed: ${n.message}
