...
<div class="container">
    ...
    <div class="content">
        ...
        <!-- ✅ FIXED: Deadline Alert Section with correct variables -->
        @if($hasDeadline)
            @php
        ...
        <!-- ✅ SIMPLIFIED: Basic Team Members List -->
        ...
        <!-- ✅ FIXED: Manager Actions with correct variables -->
