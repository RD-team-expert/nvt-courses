...
function submit() {
    ...
    if (isPublicCourse.value) {
        ...
        // ✅ FIXED: Use processedData instead of formData
            ...
            <Card class="shadow-lg max-w-4xl">
                ...
                <CardContent>
                    <form @submit.prevent="submit">
                        ...
                        <!-- Course Availabilities Section - UPDATED -->
                        <div class="mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                required
                                            />
                                            <p class="text-xs text-muted-foreground mt-1">Maximum number of seats available</p>
                                        ...
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                required
                                            />
                                            <p class="text-xs text-muted-foreground mt-1">Total number of sessions</p>
