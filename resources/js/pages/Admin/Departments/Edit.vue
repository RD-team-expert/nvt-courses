...
// Handle parent department change with safety - Handle null/none values
...
const breadcrumbs: BreadcrumbItemType[] = [
    ...
    { name: 'Edit', href: route('admin.departments.edit', props.department.id) }
]
...
<template>
    <AdminLayout :breadcrumbs="breadcrumbs">
        <div class="px-4 sm:px-0">
            <h1 class="text-xl sm:text-2xl font-bold text-foreground mb-6">Edit Department: {{ department.name }}</h1>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 pt-6 border-t">
                            ...
                            >
                                ...
                                <span v-if="form.processing">Updating Department...</span>
