        ...
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-muted-foreground">{{ post.title }}</p>
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <div v-if="form.mediable_type === 'video'" class="space-y-2">
                            ...
                            <Input v-model="videoSearch" placeholder="Search videos..." class="mb-2" />
                            <div class="border border-border rounded-lg overflow-hidden max-h-[250px] overflow-y-auto">
                                ...
                                >
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <CheckCircle2 v-if="form.mediable_id === video.id" class="h-4 w-4 text-primary" />
                                    </div>
                                </div>
                        ...
                        <div v-if="form.mediable_type === 'audio'" class="space-y-2">
                            ...
                            <Input v-model="audioSearch" placeholder="Search audio..." class="mb-2" />
                            <div class="border border-border rounded-lg overflow-hidden max-h-[250px] overflow-y-auto">
                                <div
                                ...
                                >
                                    ...
                                    <CheckCircle2 v-if="form.mediable_id === audio.id" class="h-4 w-4 text-primary" />
                                </div>
                ...
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <div v-if="existingThumbnail && !thumbnailPreview" class="relative inline-block">
                                <img :src="existingThumbnail" class="max-h-40 rounded-lg object-cover border border-border" />
                                <Button
                                    variant="destructive"
                                    size="sm"
                                    type="button"
                                ...
                                <p class="text-xs text-muted-foreground mt-1">Current thumbnail — click upload area to replace</p>
                            </div>
                            ...
                            >
                                <div v-if="thumbnailPreview">
                                    ...
                                    >
                                        <X class="h-3 w-3 mr-1" /> Remove new image
                                    </Button>
                                </div>
                                <div v-else>
                                    <ImageIcon class="h-10 w-10 mx-auto text-muted-foreground mb-2" />
                                    <p class="text-sm text-muted-foreground">
                                        {{ existingThumbnail ? 'Click to replace thumbnail' : 'Click or drag to upload thumbnail' }}
                                    </p>
                ...
                <div class="flex items-center justify-between pb-6">
                    ...
                    >
                        ...
                        {{ form.status === 'published' ? 'Update & Publish' : 'Save Changes' }}
                    </Button>
                </div>
...
const form = useForm({
    ...
    mediable_type: props.post.mediable_type || '' as '' | 'video' | 'audio',
    mediable_id:   props.post.mediable_id,
...
const existingThumbnail = ref<string | null>(props.post.thumbnail_url)
...
// ── Submit ─────────────────────────────────────────────
function submit() {
    form.post(`/admin/podcasts/${props.post.id}`, {
        forceFormData: true,
    })
}
</script>